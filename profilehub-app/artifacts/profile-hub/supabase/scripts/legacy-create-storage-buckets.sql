...
--
-- Kept only for historical reference. This was a manual one-off script that
-- lived in migrations/ without a version prefix, which breaks `supabase db push`.
--
-- Everything here is already covered by 202605240001_initial_schema.sql, which
-- creates the avatars, covers, project-media, and gallery-media buckets along
-- with equivalent "storage: *" RLS policies. Running this file would only add
-- redundant, differently-named policies over the same objects.
